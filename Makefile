...
#Be careful about the -l order, from top to underlying
LIBS = -L${SYSROOT}/usr/lib $(ARCH) -lSDL_image -lSDL_mixer -lSDL -lsndfile -lvorbisfile -lvorbis -logg -lmpg123 -lfreetype -ljpeg -lpng -lz -lbz2 -lasound -lpthread -lm
#-L./freetype-2.3.12/ 
#-L./libjpeg 
#-lSDL_ttf 
EXT_FLAGS =
...
LIBS = `sdl-config --libs` -lSDL_image -lSDL_mixer -lfreetype -lpng -ljpeg -lz -lm -lbz2
